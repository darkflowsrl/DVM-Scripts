...
BACKEND_REPO_URL="https://github.com/darkflowsrl/DVM-Backend.git"
...
VERSION=$(curl -s "$FRONTEND_API_URL" | grep 'tag_name' | sed 's/.*"tag_name": "\(.*\)",/\1/')
FRONTEND_URL="https://github.com/darkflowsrl/DVM-front/releases/download/$VERSION/frontend.AppImage"
